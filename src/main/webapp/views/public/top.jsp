...
#Head_1 {
    background: url("${pageContext.request.contextPath }/images/img/top_head1_bg.gif") repeat-x scroll 0 0 transparent;
    height: 64px;
    margin: 0 auto;
    width: 100%;
}
...
#Head_2 {
   background: url("${pageContext.request.contextPath }/images/img/top_head2_bg.gif") repeat-x scroll 0 0 transparent;
