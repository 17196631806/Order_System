...
#Menu .level1 .level1Style {
  background: url("${pageContext.request.contextPath }/images/img/menu_btn_bg.gif") no-repeat scroll 0 0 transparent;
    height: 23px;
    padding-left: 20px;
    padding-top: 5px;
    width: 135px;
...
#Menu .level1 .MenuLevel2 .level2Style{
	...
	padding-top: 5px;
	width: 112px;
	background-image:url("${pageContext.request.contextPath }/images/img/menu_arrow_single.gif") ;
	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/views/foodTable/boardList.jsp">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/foodType?method=list">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/views/public/foodList.jsp">菜品管理</a>
				</li>
                <li class="level2 level2Style">
