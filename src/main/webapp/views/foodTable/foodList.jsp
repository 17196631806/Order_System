...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="${pageContext.request.contextPath }/images/title_arrow.gif"/> 菜品列表
		</div>
    </div>
...
<div id="MainArea">
    <table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
        ...
        <tbody id="TableData">
			...
			<tr class="TableDetail1">
                ...
                <td>23.0&nbsp;</td>
				<td>
					<a href="${pageContext.request.contextPath }/views/foodTable/updateFood.html"  class="FunctionButton">更新</a>
   ...
   <!-- 其他功能超链接 -->
	<div id="TableTail" align="center">
		<div class="FunctionButton"><a href="${pageContext.request.contextPath }/views/foodTable/saveFood.html">添加</a></div>
    </div> 
</div>
</body>
</html>
